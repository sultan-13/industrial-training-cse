...
if __name__ == "__main__":
    ...
    if conn is not None:
        ...
        # Insert reporters
        insert_reporter(conn, "khaled", "khaled@ugrad.iiuc.ac.bd")
        insert_reporter(conn, "abs", "abc@ugrad.iiuc.ac.bd")
        insert_reporter(conn, "borhan", "borhan@ugrad.iiuc.ac.bd")
        insert_reporter(conn, "Karim", "karim@ugrad.iiuc.ac.bd")
        insert_reporter(conn, "deh", "deh@ugrad.iiuc.ac.bd")
