...
def extract_information(url):
    ...
    try:
        ...
        temp = response.html.find('div.time-social-share-wrapper > div > time', first=True)
        print(temp)
        tempxpath = response.html.xpath('//*[@id="container"]/div/div/div/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/time')
        print(tempxpath)
