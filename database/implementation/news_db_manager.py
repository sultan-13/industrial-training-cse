...
def create_tables(connection):
    ...
    alter_editors_table = """
    ALTER TABLE editors 
    ADD COLUMN head_office_address VARCHAR(255),
...
"""
    rename_table_query = """
RENAME TABLE editors TO publishers;
"""
    rename_authors_table = """
RENAME TABLE authors TO reporters;
"""
...
# ---------------------Assignment--------------------------
    execute_query(connection, alter_editors_table)
    execute_query(connection, rename_table_query)
    execute_query(connection, rename_authors_table)
